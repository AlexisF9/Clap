...
declare module 'vue-instantsearch/vue3/es' {
  ...
  // @ts-ignore
  export const createWidgetMixin: ({connector: any}) => InstantSearchMixin

  export const createServerRootMixin: (options: InstantSearchOptions) => VueClass<InstantSearchMixin>;
}
